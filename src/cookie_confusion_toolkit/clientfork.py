...
from .utils.common import (
    logger, USER_AGENTS, validate_authorization, ethical_check,
    safe_request, save_results, rate_limit
)
from .utils.cookie_utils import (
    Cookie, parse_cookies_from_response, simulate_browser_cookie_jar
)
...
class ClientFork:
    ...
    def _detect_available_browsers(self) -> List[str]:
        ...
        # Try Chrome
        try:
            if self._is_binary_available("chrome", system) or self._is_binary_available("google-chrome", system):
    ...
    def test_header_injection(self, 
                            ...
                            browsers: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        ...
        for browser_name in browsers:
            ...
            try:
                ...
                for i, test_case in enumerate(test_cases):
                    ...
                    if cookie_http_only:
                        test_result["http_only_note"] = "HttpOnly cookies cannot be set via JavaScript"
    ...
    def test_cookie_shadowing(self, 
    ...
    def compare_browsers(self, test_case: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "headerInjection" in test_case:
            ...
            malformed_value = test_case.get("malformedValue", "https://example.com%0d%0aSet-Cookie:+injected=value")
