...
class TestFullAssessmentIntegration:
    ...
    def test_full_assessment_basic(self, mock_bypassgen, mock_serverdrift, 
                                   mock_clientfork, mock_cookiebomb, temp_dir, auth_file):
    ...
    @patch('src.cookiebomb.CookieBomb')
    @patch('json.dump')
    def test_full_assessment_saves_results(self, mock_json_dump, mock_cookiebomb, 
                                          temp_dir, auth_file):
    ...
    @patch('src.cookiebomb.CookieBomb')
    @patch('src.clientfork.ClientFork')
    def test_full_assessment_with_options(self, mock_clientfork, mock_cookiebomb, 
                                         temp_dir, auth_file):
